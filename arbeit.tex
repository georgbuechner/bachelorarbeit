...
\chapter{Einleitung}
So, wie Friedrich Nietzsche in dem Aphorismus vom \qq{Tollen Menschen} in \emph{Die fröhliche Wissenschaft} die These vom Tode Gottes entfaltet, enthält sie weit mehr als die bloße Negation Gottes;
...
in ihr steckt eine dialektische Konzeption der Begriffe (zweite) Natur und Befreiung.\footcite[Vgl.][481]{nietzsche_morgenrote_1999}\todo{Übergang zu 2.Natur u. Befreiung zu knapp?}
...
Doch während in Hegels Deutung der Geist in der Befreiung aus der zweiten Natur, auf Grund der Endlichkeit des menschlichen Geistes, wieder in Natur verfällt, scheint bei Nietzsche in der Metapher des neuen, \qq{offene[n] Meer[es]}\footcite[Vgl.][574]{nietzsche_morgenrote_1999}, die Perspektive die ewige Wiederholung der In-Natur-Verkehrtheit zu überwinden, gegeben zu sein.
...
eine Befreiung, die sich im Bewusstsein ihrer eigenen Kritik vollzieht.\todo{Befreiung im Bewusstsein ihrer eigenen Kritik einbinden in den Nietzsche Abschnitt}
...
\chapter{Hauptteil}
Um nochmals einen anderen Einstieg zu wählen und die Fragestellung, sowie den groben Umriss der Arbeit auf alternative Art und Weise darzustellen, sei hier ein Zitat Nietzsches vorangestellt, auf welches ich gegen Ende erneut eingehen werde: \todo{Nochmals auf diesen Abschnitt eingehen?}
\begin{itemize}
...
Neben dem Moment der bloßen Unbestimmtheit, ist die einfachen Bestimmung gleichsam ungenügend, da sie \qq{eben so \emph{Negativität}\todo{eig. gesperrt}, Aufheben [ist] als das erste -- es ist nämlich das Aufheben der ersten abstrakten Negativität}\footcite[][§ 6 (Anmerkung), S. 39]{hegel_grundlinien_2017}.
...
\subsubsection{Hegels Auswegen in der Sittlichkeit}\todo{Zwischenüberschriften beibehalten?}
...
Zugleich gibt Gott den Menschen Gesetze, die (mit eingehender Naturbeherrschung) für den Menschen tatsächlich eine \qq{unendlich festere Autorität und Macht} besitzen.\todo{Evtl. Zitat aus der Dialektik der Aufklärung?}%
\footnote{
...
In der Metapher des Sonnenuntergangs, als vollständiger Zerfall alles Bestehenden, beschreibt Nietzsche allerdings zugleich die Gefahr, dass es \emph{keine} neue Formen von (natürlichen) Verknüpfungen geben wird.\todo{Fußnote weglassen, falls genauso in Teil II}%
\footnote{
...
Wir hatten von Beginn an bei Nietzsches als einen Ausweg aus der Wiederholung der Befreiung eine (neue) Qualität im Objektiven vermutet.
Auf ähnliches verweist auch Khurana, wenn er von der Sittlichkeit schreibt, dass sie selbst etwas mit sich bringen muss, was ein neues Verhältnis zu der Zweideutigkeit (also dem Zurückfallen i.d. Unfreiheit) erzeugt\footcite[Vgl.][399]{khurana_freiheit_2017}.
Dazu schlägt er vor, dass das Gesetztsein, in der neuen Notwendigkeit (in der zweiten Natur) sich zeigt oder enthalten bleibt. 
...
Er schreibt, dass wir uns unsere Freiheit immer wieder aneignen müssen, wie wir auch bei Nietzsche im Schauspieler gesehen haben, dass es einen fortwährenden Prozess der Befreiung bedarf, einen Kontext der \qq{laufenden Bildung und Umbildung}\todo{Nachweis?}: 
die zweite Natur ist nie \qq{fertig}\todo{Nachweis}.
Damit ist das Geistige nicht \emph{in der zweiten Natur}, sondern eine ebenso unmittelbare Einheit, wie zuvor und Freiheit kommt in die Unfreiheit nur vom Subjekte aus hinzu, in Form der Befreiung -- die Befreiung bleibt partiell. 
%das Geistige kommt nur in der Form der Befreiung von außen durch den Geist selbst hinein. 
Im Gegensatz dazu fand sich bei Nietzsche der Schein, der \emph{mich} wissen lässt Schein zu sein. 
Befreiung wäre hier nicht nur Seinsweise des Subjekts\footcite[Vgl.][S.???]{khurana_freiheit_2017}\todo{Khurana, S.???}, sondern in den Schein selbst eingeschrieben.
Dadurch bestünde eine geistige Einheit von Setzten und Sein.
...
Und diese Erfahrung lässt sich bei Nietzsche, wie er deutlich macht, nicht verallgemeinern:
...
das Gesetzte sollte als Nichtgesetztes erscheinen, erscheint aber nun als Gesetztes -- das Gesetzte ist als Gesetztes nicht Sein, sondern Gesetztes, darum zerfällt die Einheit erneut.%
\footnote{
...
Für den >>Erkennenden<< jedoch, ist das Gesetztsein des Seins im Schein aufgehoben (in dem Sinne, dass es zugleich negiert und bewahrt ist), was bedeutet, dass \emph{für ihn} die Einheit von Setzen und Sein vorliegt:
...
Diese These Nietzsches mag elitär anmuten, enthält aber zugleich eine eigentümliche Art des notwendigen Zusammenspiels, wie sie auch in \qq{Ueber [sic] Wahrheit und Lüge im aussermoralischen Sinne} im Gegensatz des \qq{intuitive[n] Mensch} und des \qq{vernünftige[n] Mensch}\footcite[][889]{nietzsche_geburt_1999} zu finden ist: 
dieser lebt in der Welt der Abstraktionen und baut aus \qq{Vorsorge, Klugheit und Regelmäßigkeit} seinen \qq{großen Bau der Begriffe} -- bei ihm verhärten sich die Metaphern und \qq{atheme[n] [sic] [...] die Kühle aus, die der Mathematik zu eigen ist}\footcite[][S. 882ff.]{nietzsche_geburt_1999}.
Jener nimmt nur \qq{das zum Schein und zur Schönheit verstellte Leben als real} zerreißt das \qq{Begriffsgespinst [...] durch die Kunst}\footcite[][S. 877ff.]{nietzsche_geburt_1999} und erfindet neue Metaphern.
Aber auch die neuen Metaphern des intuitiven Menschen müssen eines Tages erstarren und so finden wir den intuitiven und den vernünftigen Menschen im ewigen Zusammenspiel von Befreiung und Erstarren -- von Befreiung und In-Natur-Verkehrtheit.\footcite[vgl. dazu auch][62]{stephan_nietzscheanismus_2019}.
\\
...
Der Moment des Umbruchs, der Erneuerung, der vom \qq{vernünftigen Menschen} erlebt wird, erscheint ihm als \qq{Verdüsterung und Sonnenfinsternis}.
Für ihn bedeutet Befreiung immer Zerstörung seiner Wahrheiten, ist negativ, für den Schauspieler, den intuitiven Menschen oder den >>Erkennenden<< bedeutet sie Freiheit.
...
Damit allerdings wurde klar, dass Freiheit nur dort verwirklicht sein kann, wo das vom Geist Gesetzte ihm gegenüber selbstständig wird (dies nannten wir das Bei-Sich-Selbst-Sein-im-Anderen).
In der Sittlichkeit ist das objektiv Gegebene dem Individuum zugleich Gesetzt und Ausdruck seines Wesens. 
Der Geist ist somit in der Sittlichkeit \emph{bei sich, im Anderen}.
...
Wie die Freiheit im Gesetzten aufersteht, aber dort wieder droht zu versinken, ist auch die Verwirklichung des Geistes nur in dem Setzen möglich, welches als Nichtgesetzes erscheint und damit nicht geistig ist: 
wie die Einheit von Setzen und Sein im endlichen geist auseinanderfällt, gilt für den absoluten, dass er nur im endlichen sich verwirklichen kann, denn nur dort liegt das Gesetze als Sein vor.
Die Frage nach dem Ausweg aus der Befreiung ist also gleich der Frage nach der Einheit von Setzen und Sein.

Wir haben bei Nietzsche nach einem Ausweg aus der ewigen Wiederholung der Befreiung gesucht, aber konnten auch in dem \qq{offenen Meer} nur die gleiche Bewegung der Befreiung finden, wie sie bei Hegel vorlag. 
Damit kommt auch Nietzsche über die endlose Wiederholung der Freiheit nicht hinaus und auch für ihn bedeutet Freiheit, Befreiung aus der jeweiligen Unfreiheit. 
Sowohl Nietzsche, als auch Menkes Kritik deuten allerdings über das in der Wiederholung befangene Verhältnis heraus.
Nietzsche, und das ist der Unterschied, in seiner Philosophie des Schauspielers vielleicht deutlicher;
es lässt sich vorstellen, dass für ihn die Befreiung einmal \qq{fertig} ist.
Die Leitfrage lässt sich demnach verneinen. 
Jedenfalls konnte bei Nietzsche keine solche Möglichkeit gefunden werden, aus der ewigen Wiederholung zu entkommen, obwohl sich bei Nietzsche Ansätze finden lassen. 
So gelten der >>Erkennende<< oder der Schauspieler mit Sicherheit als Charaktere auf dem Weg zum \qq{Übermenschen}, aber was dieser dann ist, und ob bei ihm die ewige In-Natur-Verkehrtheit überwunden ist, das ist ungewiss und ich denke auch Nietzsche würde darauf keine Antwort geben können.
