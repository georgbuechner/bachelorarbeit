...
Endliche Geist ist zugleich \qq{Sein \emph{gegen} Setzung [...] und Sein \emph{durch} Setzung}\footcite[][144]{menke_autonomie_2018}.
...
\footnote{
    Der Unterschied besteht schlicht darin, dass in dem einen Fall es Freiheit/ oder Befreiung quasi \qq{eine Zeit lang} gibt, bis sie sich dann in Natur verkehrt, während im zweiten Fall die Freiheit selbst \emph{nichts anders bedeutet} als dass das Gesetzte Natur wird, denn nur dort ist Sittlichkeit und nur in der Sittlichkeit ist Freiheit.
...
\footnote{
    ...
    Würde es sich bei Nietzsche allerdings so verhalten, wäre hier eine erneute Nähe zu Hegel zu finden, denn die Verwirklichung, die sich im \qq{Erkennenden} zeigt ist nur durch die In-Natur-Verkehrtheit des Erkennenden möglich.
...
Ich nehme für die folgende Arbeit an, dass ohne den Erkennenden, der so im Schein lebt, dass er die gesetzte Welt für (erste) Natur hält, diese Einheit für den \qq{Erkennenden} nicht möglich: der Traum zerfällt.\\
...
Dabei vergessen sie bald, dass es sich ursprünglich um eine angenommene, erdachte Rolle handelte und es nur Zufall war, dass sie genau diese, und nicht eine aus unzählig anderen Rollen \qq{spielen}.
...
%Diese wird auch in Nietzsches Kritik des Baumeisters deutlich, der große, dauerhafte, planbare Dinge erschaffen will und dem Schauspieler gegenübersteht.\footcite[Vgl.][S. 596 - S. 579]{nietzsche_morgenrote_1999}.\\
...
\footnote{
    ...
    Hier wird deutlich, dass es gar kein Wesen gibt, sondern es sich immer bloß um Schein handelt, da auch, was man gemeinhin Charakter nennt, nur der \qq{sogenannte} Charakter, Schein ist.
    ...
    Ohne diese Debatte vertiefen oder für Nietzsche eine Lanze brechen zu wollen, verweise ich auf Paul Stefan, der über Nietzsche schriebt, dass dieser zugesteht, dass es \emph{kein} \qq{natürliches Wesen} der Frau gibt, sondern, \qq{dass ihr <Wesen> Ergebnis ihrer patriarchaler Unterdrückung sei}.\footcite[Vgl.][50]{stephan_nietzscheanismus_2019} 
...
zwar nicht für den Schauspieler, den \qq{Erkennenden}, aber für den Erkennenden.%
\footnote{
...
Der Schauspieler vertritt, was ich als \qq{Bewusstsein der Scheinhaftigkeit} bezeichnen, die einerseits die Notwendigkeit, andererseits die daraus folgende Veränderbarkeit des Scheins erkennt.
...
er befreit sich.
Der Schauspieler erkennt also 1. das Verhältnis von Schein und Wesen, gleichem dem \qq{Erkennenden} und 2. können wir seine Lebensweise als die der Befreiung aus der zweiten Natur bezeichnen. 
...
Aber mit dem entscheidenden Unterschied, dass dem Schauspieler seine Rolle nicht selbst wieder als Natur erscheint, der Schauspieler produziert etwas, das mich wissen lässt, dass hier Schein, Geistertanz und nichts weiter ist, dennoch ist es aber Schein, also wirklich wirkend.\todo[noline]{eigentlich falsch}
Das ist der zu suchende Ausweg, wenn man sich die Frage nach der ewigen Wiederholung der Befreiung stellt.\todo[noline]{Nicht sicher, ob das so richtig ist}
...
Zu Beginn hatte ich auch die Kritik formuliert, dass bei Nietzsche das \qq{Bei-Sich-Sein-im-Anderen} nicht (im übersittliche Individuum) aufgenommen ist.
...
Je nachdem ob \qq{noch Jahrtausende lang} als Metapher für die Unendlichkeit gesehen wird ergeben sich daraus verschiedene Positionen. 
...
\todo[noline]{besserer einleitender Satz}
Das haben wir zum Beispiel in Menkes Formulierung \qq{Durchstoßen des Scheins der Notwendigkeit} gesehen oder darin, dass die Affirmation der zweiten Natur das Ersetzen der \qq{falschen} zweiten Natur durch eine neue ist:
also auch eine Befreiung aus der zweiten Natur.
Bei Nietzsche ist uns die Befreiung in dem Schauspieler begegnet, der sich von der Natur freimacht, indem er sich dem \qq{sogenannten Charakter} entledigt und damit den Schein durch einen neuen ersetzt.
...
Auf ähnliche Art und Weise, fragt sich, wie bei Menke das \qq{plötzliche Hervortreten der Tat} zu verstehen ist.
Diese Tat beschreibt Menke als die eigentliche Affirmation der zweiten Natur, weil sie 
\emph{gegen} die (\qq{falsche}) zweite Natur sich durchsetzt. 
Indem sie aber die Überwindung der zweiten Natur bedeutet, muss sie schon über sie hinaus sein. \todo[noline]{Zitat suchen: Grenzen kennen -> Grenzen schon überwunden}
...
Zu beginn der Arbeit hatten wir bei Khurana eine ähnliche Perspektive vorgefunden, dass Geist wesentlich ist \qq{aus der Natur herzukommen und sich von der Natur zu befreien}. 
...
Kommt jedoch der Impuls zum Essen aus dem \emph{Bedürfnis} des Tiers, woher kommt der Anstoß für den Geist sich aus der (jeweiligen) Natur zu befreien, woher kommt die \qq{plötzlich hervortretende Tat?}?
