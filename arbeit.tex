...
Aber es bestimmte sich nur durch dieses \qq{\emph{Wissen [und] Wollen}}\footnote{Hervorhebung von mir} des einzelnen Subjekts.
...
Umstritten scheint mir beispielweise die Annäherung Nietzsches an (links) idealistische Positionen, welche Paul Stephan als die Nietzsche am wenigsten zuordenbare Strömung bezeichnet.\footfullcite[Vgl.][26]{stephan_nietzscheanismus_2019}
...
Hier schließt sich also eine weitere Forschungsfrage am, die sich im Rahmen dieser Arbeit nicht beantworten lässt.
