...
\chapter{Hauptteil}
Um nochmals einen anderen Einstieg zu wählen und das Grundproblem, sowie den groben Umriss der Arbeit auf andere Weise darzustellen, und das Problem gewissermaßen von hinten aufzurollen, sei hier ein Zitat, auf das ich gegen Ende erneut eingehe, vorangestellt:
\begin{itemize}
    \item[] so finden wir als reifste Frucht an ihrem [der Sittlichkeit] Baum das \so{souveraine} (sic) \so{Individuum}, das nur sich selbst gleiche, das von der Sittlichkeit der Sitte wieder losgekommene, das autonome übersittliche Individuum (denn \qq{autonom} und \qq{sittlich} schliesst sich aus) [...]\footATCite[][293]{nietzsche_jenseits_2014}
\end{itemize} 
...
Zunächst spricht Nietzsche im selben Abschnitt von der Sittlichkeit als eine \qq{\so{vorhistorische} Arbeit}.
Diese Sittlichkeit beschreibt Nietzsche als die Entwicklung des Menschen, in der er sich durch Zurichtung und Gewohnheit von seiner Natur befreit, die aber zugleich nur durch die \qq{sociale[] (sic) Zwangsjacke} erreicht wird und letztendlich der Freiheit gegenübersteht, weil sie eine neue Form von inneren Zwang, von innerer Notwendigkeit schafft.
Darum ist die \qq{reifste Frucht} der Sittlichkeit auch dasjenige Individuum, welches sich von ihr wieder befreit.
Ohne hier den Anspruch zu erheben, Nietzsche habe es genau so gemeint, oder sei selber Hegelianer, liegt hier dennoch etwas vor, was stark an Hegels Begriff des Geistes erinnert, nämlich, dass er dadurch bestimmt ist \qq{aus der Natur herzukommen und sich von der Natur zu befreien}\footATCite[][294]{khurana_freiheit_2017}.
\todo[noline]{Search for exact citation: \qq{Geist is wesentlich die [...]}}
\todo[noline]{About my reading of Nietzsche}
Geist so zu verstehen, wie Nietzsche und Hegel es tun, bedeutet, dass Geist nicht einmal aus der Natur hervorgegangen ist und nun Geist ist, sondern das das Geistige sich wesentlich dadurch bestimmt, sich (immer wieder) von der Natur zu unterscheiden und aus ihr hervorzutreten.
Die Natur von der er sich unterscheidet kann zugleich aber nicht nur die erste Natur sein, sondern die von ihm gesetzte zweite Natur. 
...
Das nicht mehr Vorhistorische ist nun, sich auch von diese wieder zu befreien.
Dadurch ist Freiheit explizit als prozesshaft zu verstehen. 
...
Nietzsche spricht diesen Ausweg ganz konkret an, er spricht vom \qq{Ende des ungeheuren Prozesses} und vom \qq{übersittliche[n] Individuum}, welches an diesem Ende steht.\footATCite[][293]{nietzsche_jenseits_2014} 
...
Hier wird zunächst das Paradox, in welches sich die Autonomie verstrickt beschrieben und dann der Ausweg aus in der Sittlichkeit.
...
Dies ist darum so spannend, weil Nietzsche dennoch deutlich macht, dass die Sittlichkeit der Notwendige Schritt \emph{vor} dem autonomen Individuum ist und zugleich seine Sittlichkeitsdefinition an Hegels Kritik an Kants moralische Konzeption ansetzt.
...
Ebenso definiert auch Hegel die Sittlichkeit als handelnde Verwirklichung des Guten und diese Definition über das Handeln, bildet die Kritik an Kants formalistischer Definition.\\

\emph{3. Kritik: Freiheit als das sich bestimmende}\\
Der dritte Aspekt deutet sich genau an dieser Stelle an. 
Während Kants formalistische Definition der Freiheit inhaltsleer bleibt, kann nach Hegel Freiheit nicht als reine Unbestimmtheit oder bloße Abstraktion verstanden werden.\footATCite[Vgl.][38]{hegel_grundlinien_2017}
Auch das Moment der einfachen Bestimmung, ist ebenso ungenügend, da sie \qq{eben so \emph{Negativität}, Aufheben [ist] als das erste - es ist nämlich das Aufheben der ersten abstrakten Negativität.}\footATCite[][39]{hegel_grundlinien_2017}
Khurana drückt dies so aus, dass das Subjekt einer Bestimmung bedarf, die dem Ich einen konkreten Inhalt gibt und (diese Bestimmung) selbst die Form des Ich erhält\footATCite[Vgl.][285]{khurana_freiheit_2017}. 
Freiheit ergibt sich erst in der Einheit dieser beiden Momente und Freiheit des Willens ist eben das: sich \qq{als \textit{bestimmt}, \textit{beschränkt} zu setzen und bei sich, d.i. in seiner \textit{Identität} mit sich und Allgemeinheit zu bleiben.}\footATCite[][40, §7]{hegel_grundlinien_2017}\\

\emph{4. Bei sich sein im Anderen}\\
Hieraus kommt Khurana schließlich auf Hegels Formel des \qq{Bei-Sich-Sein-im-Anderen}. 
\todo[noline]{Citation?}
Und das ist, um den Bogen zurück zum ersten Aspekt zu schlagen, in der zweiten Natur theoretisch erreicht: 
indem das Subjekt Natur setzt, ist es in der Natur bei sich, das ist Sittlichkeit.
Hiervon ausgehend ist Nietzsche zu kritisieren, da er dieses Bei-Sich-Sein-im-Anderen nicht mit in das übersittliche Individuum mit aufnimmt.  
Dennoch fast Nietzsche das Problem, aber auch die Möglichkeit der zweiten Natur mit Hegel richtig auf.
...
Menke beschreibt dies als das soziale Teilnehmen an einer Praxis. \footATCite[Vgl.][28 ff]{menke_autonomie_2018}
Von der Seite der Teilnahme gedacht, ist so zu verstehen, inwiefern das Gute zu seinem Inhalt kommt: im Gegensatz nämlich zum \qq{abstrakten Guten} (bei Kant), ist das \qq{objektiv Sittliche [...] durch die Subjektivität \emph{konkrete} Substanz}\footATCite[][161, §144]{hegel_grundlinien_2017}.
...
\footnote{%
    ...
    Erst die dritte dieser Stufen stellt die Sittlichkeit, als \qq{der zur \emph{vorhandenen Welt} und \emph{zur Natur des Selbstbewusstseins gewordene Begriff der Freiheit}} (\ATcite{hegel_grundlinien_2017}, S. 161) dar.
    ...
    Es ist nämlich gleichfalls so, dass diese Stufen nicht bloß nebeneinander stehen, sondern z.B. \qq{die Form der Gewohnheit [...] alle Stufen des Geists} (\ATcite{khurana_freiheit_2017}, S. 401) betrifft.
...
Khurana schreibt unter anderem, dass die Sittlichkeit selbst etwas mit sich bringen muss, was einen neues Verhältnis zu der Zweideutigkeit (also dem Zurückfallen i.d. Unfreihiet) erzeugt\footATCite[Vgl.][399]{khurana_freiheit_2017}.
...
Khurana schreibt nun allerdings weiter, dass die zweite Natur gerade die gegenteilige Tendenz enthält, das \emph{Gesetzt}-Sein, im Sein untergehen zu lassen, bzw. dass Geist und Natur nur zu einer unmittelbaren, nicht zu einer geistigen Einheit kommen.\footATCite[Vgl.][401]{khurana_freiheit_2017}.
