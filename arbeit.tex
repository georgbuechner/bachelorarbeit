...
\title{
    {Zweite Natur und Befreiung}\\ 
    {\large zwischen Kritik und Affirmation}\\
    {\bigskip}
...
\subsubsection{Die Wiederholung des Paradox}
Wie oben bereits in der Analogie zu Gott ewähnt, schafft der Mensch in der Sittlichkeit sich Gesete, die zwar 1. das Paradox der Autonomie aufheben, d.h. sie sind eigene, inhaltlich bestimmte und zugleich Wesens-Konstituierend Gesetze, aber sie werden 2. zu einer Macht, die noch die Macht der Natur überbietet in der Autorität für den Menschen.
D.h. das Schaffen (oder Setzen) von Gott, gibt den Menschen die Moral, aber verskalvt ihn zu gleich einer neuen äußeren Natur, einer \emph{zweiten} Natur: \qq{das Sittliche [erscheint] als eine \emph{zweite Natur}}.
