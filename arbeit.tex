...
Der Mensch hat Gott geschaffen, als dann außer ihm und selbstständig existieren, nur so konnte er ihn töten und damit sich von ihm wieder befreien.\footfullcite[Vgl.][S. 481. Nachfolgend zitiert als \emph{KSA 3}.]{nietzsche_morgenrote_1999}
...
Hegels Ausweg besteht darin Freiheit sozial zu verstehen.\footfullcite[Vgl.][49]{khurana_paradox_2019}
...
Dies erinnert stark an Hegels Begriff des Geistes, nämlich, dass dieser, wie Thomas Khurana schreibt, dadurch bestimmt ist \qq{aus der Natur herzukommen und sich von der Natur zu befreien}\footfullcite[][S. 294. Nachfolgend zitiert als \emph{LdF}. ]{khurana_freiheit_2017}.
...
Nietzsche spricht diesen Ausweg ganz konkret an, er spricht vom \qq{Ende des ungeheuren Prozesses} und vom \qq{übersittliche[n] Individuum}, als Ergebnis dieses Prozesses.\footcite[][293]{nietzsche_jenseits_2014} 
...
Nietzsche definiert Sittlichkeit als \qq{die \emph{herkömmliche} Art zu handeln und abzuschätzen}\todo{Zitat nachschlagen!}%
\footnote{
...
Nur durch diese >>Bildung<< kommt der Mensch also zu den \qq{>>guten Dinge[n]<<}\footcite[][297]{nietzsche_jenseits_2014}. 
So ist auch bei Hegel Sittlichkeit als handelnde Verwirklichung des Guten\footfullcite[Vgl.][§ 142, S. 161. Nachfolgend zitiert als \emph{Rph}.]{hegel_grundlinien_2017} definiert und auch zu ihr kommt der Mensch nach Hegel nur durch Bildung\footcite[Vergleiche dazu etwa:][§ 187 A, S. 191]{hegel_grundlinien_2017}.
...
Neben dem Moment der bloßen Unbestimmtheit, ist die einfachen Bestimmung gleichsam ungenügend, da sie \qq{eben so \so{Negativit"at}, Aufheben [ist] als das erste -- es ist nämlich das Aufheben der ersten abstrakten Negativität}\footcite[][§ 6 A, S. 39]{hegel_grundlinien_2017}.
...
Hieraus kommt Khurana auf Hegels Formel des \qq{Bei-Sich-Sein-im-Anderen}\footcite[][283]{khurana_freiheit_2017}.\todo{Zitat nachschlagen!}
...
Die Kritik Hegels, an Kants Begriff der Autonomie, hat seinen Grund auch dem, was ich weiter oben als notwendige Verknüpfung von Abstraktion (Bestimmungslosigkeit) und Bestimmung (sich einen Inhalt geben), nannte. 
...
Und auch bei ihm existiert der Begriff der Handlung: \qq{\emph{handle} stets nach derjenigen Maxime von der du zugleichen wolle kannst, dass sie ein allgemeines Gesetz werde}\footcite[][S. 51. Hervorhebung von mir.]{kant_kritik_2014}.
Allerdings bestimmt sich, ob diese oder jene Handlung gut, oder schlecht ist, nur durch das \qq{Wissen [und] Wollen} des einzelnen Subjekts.
...
Das Subjekt muss nach Menke als \qq{Teilnehmer an einer Praxis}\footcite[][28]{menke_autonomie_2018} gesehen werden und nur in dieser verwirklicht sich das Gute durch das Handeln der Individuen. 
...
Der Inhalt des Gesetzes bestimmt sich durch die Handlungen der Subjekte, er kommt somit nicht von außen dazu, sondern er \emph{ist} bereits.
...
Einen ähnlichen Gedanken, findet sich auch bei Nietzsche. Er schreibt, dass es nach dem Tod Gottes \qq{noch Jahrtausende lang Höhlen geben [wird], in denen man seinen Schatten zeigt. -- Und wir -- wir müssen auch noch seinen Schatten besiegen!}\footcite[][467]{nietzsche_morgenrote_1999}
...
Damit damit wirkt das vom Menschen Geschaffene letztlich als \emph{Wesen} und es ist demnach bedeutender, \qq{wie die Dinge heißen, als was sie sind}, oder (ursprünglich) waren.
...
Ohne dieses neue Setzten, wäre die plötzliche Tat nichts als \qq{der Fanatismus der Zertrümmerung}\footcite[][§ 5 A, S. 39]{hegel_grundlinien_2017}.
...
\footnote{
    Darauf verweißt auch Menke: \qq{Ästhetisierung und Politisierung sind die beiden Grundformen der Befreiung}\footcite[][50]{menke_autonomie_2018}.
}
