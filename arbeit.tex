...
\subsection{Der Schein}
Wenn Nietzsche also schreibt, dass es mehr darauf ankommt, wie die Dinge heißen, als, was sie sind, dann ist das eigentlich keine Revision seiner Kritik der Metapher, sondern die Unterstreichung dessen, was mit der Kritik am Denken in Metaphern eigentlich gemeint ist.
Nietzsche betont hier, dass die Macht des Menschen/ des Denken in dem Schaffen von Dingen besteht, in dem Recht \qq{Namen zu geben}\footcite[][S. 260. Wir sehen hier, dass sich dieser Gedanke, von seinen Frühwerken, bis zur seiner düsteren Phase durchzieht.]{nietzsche_jenseits_2014}, denn \qq{es genügt, neue Namen [...] zu schaffen, um auf die Länge hin neue >>Dinge<< zu schaffen}\footcite[][417]{nietzsche_morgenrote_1999}. 
...
Daher fordert Nietzsche ein völlig anderes Verhältnis, welches zunächst widersprüchlich erscheint, und damit kommen wir endlich zu dem Begriff des Scheins und den Zitaten die ich bereits mehrfach angeschnitten hatte:
...
Nietzsche fordert hier also die Paradoxe Einheit von Setzen und Sein, denn sie ist nicht, wie bei Menke betrachtet der Übergang von Verwirklichung in Entwirklichung, und Entwirklichung in Verwirklichung, sondern sie ist tatsächlich zugleich Wesen und Geistig und damit Vollendung des Geistes, ohne Fall des Geistes zu sein.


\subsection{(a) Was bedeutet Schein?}
Nietzsche mag als der große Zerstörer der Wahrheit gelten:
sie sei nichts als eine Metapher, die Menschen lieben auch die Wahrheit nicht, sondern nur die Nützlichkeit und so weiter und so fort, aber was bedeutet es für Nietzsche genau, dass die Wahrheit nichts als eine Metapher ist? 
Das das Wort nichts mehr mit dem Ding zu tun hat?
Gerade das Wort Metapher schließt aber bereits eine gewisse Eindeutigkeit aus. 
Nietzsche beschreibt die Wahrheit, die nichts mehr mit dem Ding zu tun hat, nicht bloß als einen Fehler des Menschen, sondern er affirmiert die Macht des Menschen Metaphern für die Dinge zu entwickeln. 
Diese Kritik ist am prägnantesten formuliert in \qq{Über Wahrheit und Lüge im aussermoralischen Sinne}, aber wohl einer der Dinge, die Nietzsche Sein ganzes Werk durch begleiten.\\

Es gibt mehrere Dimensionen, von denen aus Nietzsche Wahrheit kritisiert:
sie ist 1. etwas Anthropomorphistisches, der Mensch hat sie sich nur ausgedacht, 
2. ist sie Begriffskritik -- Nietzsche argumentiert, dass Problem an der Wahrheit und dem Versuch sie mit unseren Begriffen auszusprechen, ist, dass ein Begriff notwendig das Subsumieren, also das Gleichsetzen von Nicht-Gleichem ist --
und 3. ist sie die Kritik der Metapher -- Wahrheit ist immer nur Metapher, wir \emph {glauben} nur etwas über die Dinge zu wissen -- und wir vergessen, dass es sich mal um eine Metapher handelte.\footcite[Vgl.][S. 877 ff.]{nietzsche_geburt_1999}
Hier ist bereits die Zweideutigkeit der Metapher deutlich zu sehen:
Nietzsche kritisiert weniger die Metapher selbst, aber er das Vergessen, dass es (nur) eine Metapher ist.

In der fröhlichen Wissenschaft schreibt Nietzsche, das unsere Begriff mit dem \qq{ursprünglichen Ding} nichts mehr zu tun hat, unsere Begriff sind ihm ganz fremd, sie sind ihm \qq{übergestülpt}, zugleich revidiert er dieser Kritik aber und beton, dass \qq{unsäglich mehr daran liegt, \so{wie die Dinge heissen}, als was sie sind}\footcite[][§ 58. S. 422.]{nietzsche_morgenrote_1999}.
An dieser Stelle sehen wir die Direkte Überleitung von Nietzsches Begriff-Kritik zum Schein: 
aus d
