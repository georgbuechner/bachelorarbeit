...
Es fragt sich allerdings, ob diese Einheit, die der \qq{Erkennende} erkennt ohne den Erkennenden möglich ist.
So schreibt Nietzsche, dass letzterer ein \qq{Festordner} ist, um \qq{den irdischen Tanz in die Länge zu ziehen} und \qq{\so{die Dauer des Traumes aufrecht zu erhalten}}\footcite[][§ 54, S. 417]{nietzsche_morgenrote_1999}.
Ohne den Erkennenden, der so im Schein lebt, dass er die gesetzte Welt für (erste) Natur hält, ist diese Einheit für den \qq{Erkennenden} nicht möglich: der Traum zerfällt.\\
