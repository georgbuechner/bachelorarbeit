...
Der Mensch hat Gott geschaffen, als dann außer ihm und selbstständig existieren, nur so konnte er ihn töten und damit sich von ihm wieder befreien.\footfullcite[Vgl.][481]{nietzsche_morgenrote_1999}
...
\footnote{
    Dass Setzen in Sein umschlägt bedeutet, dass das vom Menschen Gesetzte als Nichtsgesetzes, als Natur, oder \emph{Sein} erscheint\footfullcite[Vgl.][142]{menke_autonomie_2018}: 
...
Dies erinnert stark an Hegels Begriff des Geistes, nämlich, dass dieser, wie Thomas Khurana schreibt, dadurch bestimmt ist \qq{aus der Natur herzukommen und sich von der Natur zu befreien}\footfullcite[][294]{khurana_freiheit_2017}.
...
So ist auch bei Hegel Sittlichkeit als handelnde Verwirklichung des Guten\footfullcite[Vgl.][§142, S. 161]{hegel_grundlinien_2017} definiert und auch zu ihr kommt der Mensch nach Hegel nur durch Bildung\footcite[Vergleiche dazu etwa:][§ 187, S. 191]{hegel_grundlinien_2017}.
...
\footnote{
    Dieses Moment des \qq{Bei-Sich-Sein-im-Anderen} findet sich so in dem aufgegriffenen Zitat Nietzsches nicht wieder. 
...
Dieser Doppelcharakter ist der, welcher sich in der Sittlichkeit ausdrückt, welche Hegel als 
\begin{itemize}
...
Allerdings bestimmt sich, ob diese oder jene Handlung gut, oder schlecht ist, nur durch das \qq{\emph{Wissen [und] Wollen}}\footnote{Hervorhebung von mir} des einzelnen Subjekts.
Indem dies nach Hegel ein nur gedachter Prozess ist, ist die Entscheidung darüber stets \qq{sowohl fähig wahr, als bloße \so{Meinung} und \so{Irrtum} zu sein}\footcite[][136]{hegel_grundlinien_2017}.
...
Das Subjekt muss nach Menke als \qq{Teilnehmer an einer Praxis}\footcite[][28]{menke_autonomie_2018} gesehen werden, in der sich das Gute konstituiert.
...
im Gegensatz nämlich zum \qq{abstrakten Guten} (bei Kant), ist das \qq{objektiv Sittliche [...] durch die Subjektivität \emph{konkrete} Substanz}\footcite[][§144, S. 161.]{hegel_grundlinien_2017}.
Der Inhalt des Gesetzes bestimmt sich durch die Handlungen der Subjekte, der Inhalt kommt somit nicht von außen dazu, sondern er \emph{ist} bereits.
